...
import SmallStats from "./blog/SmallStats";
...
import TopReferrals from "./blog/TopReferrals";
...
const BlogOverview = ({ smallStats }) => (
  <Container fluid className="main-content-container px-4">
    ...
    <Row noGutters className="page-header py-4">
      <PageTitle title="Chama Plus" subtitle="Dashboard" className="text-sm-left mb-3" />
    </Row>
