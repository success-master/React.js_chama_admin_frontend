                    ...
                    <Paper elevation={1} className="rounded-8">
                        ...
                        <List>
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="Suspended accounts" disableTypography={true}/>
                            </ListItem>
                            <ListItem
                                button
                                component={NavLink}
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="Removed accounts" disableTypography={true}/>
                            </ListItem>
                        </List>
                    </Paper>
                </FuseAnimate>
